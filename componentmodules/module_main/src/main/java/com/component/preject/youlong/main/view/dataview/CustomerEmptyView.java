...
public class CustomerEmptyView  extends LinearLayout implements StateEmptyInterface {
    ...
    private void initView(Context context) {
      View view=LayoutInflater.from(context).inflate(R.layout.layout_customer_empty, this, true);
    ...
    @Override
    public void visible(boolean visible) {//启动动画
        /*if (visible) {
