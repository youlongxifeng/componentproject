package com.component.preject.youlong.manage.permissions;
...
public class PermissionsManager {
     ...
     * The Activity variable is nullable, but if it is null, the method will SystemError to execute.
     ...
     * will SystemError to work as the activity reference is necessary to check for permissions.
     *
